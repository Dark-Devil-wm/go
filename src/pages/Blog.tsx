...
export const Blog = () => {
  useSEO('Strength Journal - Performance Insights', 'Official performance journal of Strength Fitness London. Insights into biomechanics, clinical nutrition, and elite mindset.');
  ...
  const posts = [
    ...
    {
      title: 'The Art of Discipline in Modern London',
      excerpt: 'Mindset shifts required to maintain elite physical standards while navigating the worlds most competitive city.',
      category: 'Mindset',
      date: 'Apr 28, 2024',
      author: 'Founder',
      ...
      <section className="px-6 py-24 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24">
          {posts.map((post, i) => (
            ...
            >
              <div className="aspect-[16/9] overflow-hidden rounded-[40px] mb-8 border border-white/5 relative">
                <img 
                  src={post.img} 
                  alt={post.title} 
